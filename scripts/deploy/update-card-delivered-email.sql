-- Run on VPS after deploy: docker exec cardon-prod-postgres psql -U cardon -d cardon -f /tmp/update-card-delivered-email.sql
...
SELECT code, variables FROM email_templates WHERE code = 'CARD_DELIVERED';

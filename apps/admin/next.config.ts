...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/finance', destination: '/finance/supplier', permanent: false },
      { source: '/finance/dashboard', destination: '/finance/supplier', permanent: false },
      { source: '/finance/payments', destination: '/finance/gateway-fee', permanent: false },
      { source: '/finance/providers', destination: '/finance/supplier', permanent: false },

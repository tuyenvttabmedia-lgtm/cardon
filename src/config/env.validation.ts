...
export const envValidationSchema = Joi.object({
  ...
  WEB_INTERNAL_URL: Joi.string().optional().allow(''),
  WEB_REVALIDATE_SECRET: Joi.string().min(16).optional().allow(''),
  ADMIN_INTERNAL_URL: Joi.string().optional().allow(''),
  ...
  SEPAY_API_KEY: Joi.string().optional().allow(''),
  SEPAY_WEBHOOK_SECRET: Joi.string().optional().allow(''),
  SEPAY_HMAC_SECRET: Joi.string().optional().allow(''),

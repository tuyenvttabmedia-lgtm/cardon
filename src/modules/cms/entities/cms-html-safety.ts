...
/** Allowed formatting tags for public CMS HTML render. */
...
/**
 * Sanitize CMS HTML for public display. Raw content in DB is unchanged;
 * call this only at render/API boundary.
 */
